# -*- coding: utf-8 -*-
"""vgg11_scratch_cifar10_prune.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1e1TgF6zM1LXvSxlCg55_PFm_ONSaFnDM
"""
...
model = torch.load("/content/drive/MyDrive/vgg11cifar10_scratch.pth", map_location=device, weights_only=False)
model.to(device)
model.eval()

torch.save(model.state_dict(), "vgg11cifar10_weights.pth")
...
ratios = sorted(accuracy_dict.keys())
accuracies = [accuracy_dict[r] for r in ratios]
flops_values = [flops_dict[r]/1e6 for r in ratios]  # In MFLOPs
params_values = [params_dict[r]/1e6 for r in ratios]  # In MParams
...
# 2. FLOPs Plot
plt.subplot(1, 3, 2)
plt.plot(ratios, flops_values, 'ro-')
...
# 3. Parameters Plot
plt.subplot(1, 3, 3)
plt.plot(ratios, params_values, 'go-')
...
plt.savefig('pruning_results.pdf')
